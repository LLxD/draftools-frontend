        ...
        <>
            ...
            <div className="row search-box border border-white rounded">
                ...
                {searchChampion.map((champion) => (
                    <ChampionIcon addChampion={addChampion} key={champion.key} id={champion.key} nome={champion.name} tags={champion.tags} img={champion.square_image} loading={champion.loading_image} />)
                )}
